...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  table.compact th, table.compact td { padding:10px 8px; font-size:14.5px; white-space:normal; word-break:break-word; }
  table.compact th { font-size:11.5px; line-height:1.3; }
